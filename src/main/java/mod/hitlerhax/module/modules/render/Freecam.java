...
public class Freecam extends Module {
	...
	public void onDisable() {
		...
		if (mc.world.getLoadedEntityList().contains(ridingEntity))
			mc.player.ridingEntity = ridingEntity;
	}
	...
	public void onUpdate() {
		if (mc.world.getLoadedEntityList().contains(ridingEntity)) {
			...
			entity.posX = ridingEntity.posX;
			entity.posY = ridingEntity.posY + 0.5;
			entity.posZ = ridingEntity.posZ;
